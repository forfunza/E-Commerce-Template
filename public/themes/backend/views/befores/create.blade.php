{{ Form::open(array('action' => array('BeforesController@store'), 'method' => 'post', 'class' => 'form-horizontal bucket-form', 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input name="author" value="" type="text" class="form-control" required>
				</div>
			</div>
			<div class="form-group">
