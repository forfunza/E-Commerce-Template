{{ Form::open(array('action' => array('CelebritiesController@store'), 'method' => 'post', 'class' => 'form-horizontal bucket-form', 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<div class="fileupload fileupload-new" data-provides="fileupload">
						...
						<div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 500px; max-height: 450px; line-height: 20px;"></div>
						<div>
