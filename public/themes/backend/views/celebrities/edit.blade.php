{{ Form::open(array('action' => array('CelebritiesController@update',$celebrity->id), 'method' => 'put', 'class' => 'form-horizontal bucket-form', 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<div class="fileupload fileupload-{{ !empty($celebrity->image) ? 'exists' : 'new'}}" data-provides="fileupload">
						...
						<div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 500px; max-height: 450px; line-height: 20px;">
							@if(!empty($celebrity))
							<img src='{{ !empty($celebrity->image) ? $celebrity->image : "" }}'>
							@endif
						</div>
						<div>
