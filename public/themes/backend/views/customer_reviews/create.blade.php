{{ Form::open(array('action' => array('CustomerReviewsController@store'), 'method' => 'post', 'class' => 'form-horizontal bucket-form', 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input name="caption" value="" type="text" class="form-control">
				</div>
			</div>
