{{ Form::open(array('action' => array('PromotionsController@store'), 'method' => 'post', 'class' => 'form-horizontal bucket-form', 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		...
		<div class="panel-body">
            ...
            <div class="form-group">
				...
				<div class="col-sm-6">
					<input name="price" value="{{ Input::old('price') }}" type="text" class="form-control" required>
				</div>
			</div>
			<div class="form-group">
