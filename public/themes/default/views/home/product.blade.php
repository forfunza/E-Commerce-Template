<section>
    ...
    <div class="product-block">
        ...
        <div class="item">
        	...
        	<a href="{{ action('HomeController@product_detail',1) }}">
...
<section>
	<h2><i class="tl"></i><span>Nourishing</span><i class="tr"></i></h2>
    <div class="product-block">
    	<div id="owl-item" class="owl-item owl-carousel">
        <div class="item">
        <div class="share-icon">
...
<section>
	<h2><i class="tl"></i><span>whitening</span><i class="tr"></i></h2>
    <div class="product-block">
    	<div id="owl-item" class="owl-item owl-carousel">
        <div class="item">
        <div class="share-icon">
...
<section>
	<h2><i class="tl"></i><span>cleansing</span><i class="tr"></i></h2>
    <div class="product-block">
    	<div id="owl-item" class="owl-item owl-carousel">
        <div class="item">
        <div class="share-icon">
...
<section>
	<h2><i class="tl"></i><span>serum</span><i class="tr"></i></h2>
    <div class="product-block">
    	<div id="owl-item" class="owl-item owl-carousel">
        <div class="item">
        <div class="share-icon">
